        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-2xl font-black">Crop<span className="text-green-400">AI</span></span>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="mailto:support@cropai.com" className="flex items-center gap-3 text-gray-300 hover:text-green-400 transition-colors group">
                <div className="p-2 bg-gray-800 rounded-lg group-hover:bg-green-900 transition-colors">
                  <Mail className="h-4 w-4" />
                </div>
                <span className="text-sm">support@cropai.com</span>
              </a>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2024 <span className="font-semibold text-green-400">CropAI</span>. All rights reserved.
            </p>
